...
export const DATA_USERS: cardUserInterface[] = [
  {
    id: 1,
    ...
    tag: ['coffee', 'tea'],
    details:
      'Lysandre Morel naquit un matin de printemps, dans une petite ville portuaire battue par les vents et bercée par le cri des mouettes. Dès son plus jeune âge, il montra un rapport étrange au monde qui l’entourait : il observait plus qu’il ne parlait, mémorisait des détails que personne d’autre ne voyait, et se perdait dans de longues rêveries en fixant l’horizon. Ses parents, gens simples mais curieux de nature, comprirent rapidement que leur fils avait une manière singulière de percevoir la vie. Ils l’encouragèrent à lire, à explorer, à poser des questions — même celles qui semblaient absurdes. C’est ainsi qu’il développa une soif insatiable de savoir, nourrie autant par les livres poussiéreux de la bibliothèque municipale que par les histoires racontées au coin du feu par les vieux pêcheurs.',
    galery: [
  ...
  },
  {
    ...
    tag: ['tech', 'soft', 'sport'],
    details:
      'À l’adolescence, Lysandre se distingua par une imagination fertile et un talent certain pour l’écriture. Ses cahiers étaient remplis de récits épiques, de poèmes mélancoliques et de dialogues entre des personnages qu’il inventait mais qui semblaient si réels que ses camarades en étaient troublés. Pourtant, derrière cette créativité se cachait une âme tourmentée, hantée par le sentiment qu’il était destiné à quelque chose de plus grand, quelque chose qui dépassait les frontières étroites de sa ville natale. Ce désir d’évasion devint une obsession : il voulait découvrir le monde, comprendre ses mystères, s’aventurer là où d’autres n’osaient pas poser le pied.',
    galery: [
  ...
  },
  {
    ...
    tag: ['design', 'video'],
    details:
      'C’est à dix-huit ans, une nuit de pleine lune, qu’il prit sa première grande décision : quitter son foyer pour entamer un voyage sans plan précis. Armé seulement d’un sac usé, de quelques carnets et d’un stylo plume, il s’élança sur les routes. Ses pas le menèrent d’abord vers les grandes cités, où il découvrit la foule, le bruit, les contradictions sociales et la richesse des cultures. Plus tard, il traversa des montagnes, s’enfonça dans des forêts, et vécut des jours entiers auprès de peuples dont il ignorait jusqu’à l’existence. Chaque rencontre devint une page de son journal, chaque paysage une peinture dans son esprit.',
    galery: [
      'https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=300&h=300&q=60',
      'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=300&h=300&q=60',
      'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=300&h=300&q=60',
